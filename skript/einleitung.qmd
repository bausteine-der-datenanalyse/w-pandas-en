...
## Slicing
::: {.border}
![two-dimensional dataset](00-images/two-dimensional-dataset-slicing-mf-mp.png){width="45%" fig-alt="A two-dimensional block representing a dataset. Arrows represent the two axes. The zero axis corresponds to length (top to bottom) and the first axis to the width of the dataset."}
